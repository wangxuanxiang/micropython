...
//====================================================软件 IIC 驱动====================================================
	...
	#define DL1B_SCL_PIN                ( IO_P65 )                                      // 软件 IIC SCL 引脚 连接 DL1B 的 SCL 引脚
...
#define DL1B_XS_ENABLE              ( 0  )                                      // 是否启用 INT 引脚 启用则会自动更新数据
#if DL1B_XS_ENABLE
#define DL1B_XS_PIN                 ( IO_P47 )
#endif

#define DL1B_INT_ENABLE             ( 0  )                                      // 是否启用 INT 引脚 启用则会自动更新数据
#if DL1B_INT_ENABLE
#define DL1B_INT_PIN                ( 暂不支持 )
#endif
